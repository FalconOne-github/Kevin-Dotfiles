...
theme.menu_fg_normal                            = "#E5BD1A"
theme.menu_fg_focus                             = "#ff8c00"
theme.menu_bg_normal                            = "#16161e"
...
local bar_spr   = wibox.widget.textbox(markup.font("Terminus 5", " ") .. markup.fontfg(theme.font, "#777777", "|") .. markup.font("Terminus 5", " "))
...
function theme.at_screen_connect(s)
   ...
   s.quake = lain.util.quake({ app = "urxvt", height = 0.50, argname = "--name %s" })
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", opacity = 0.8, screen = s, height = dpi(32), bg = theme.bg_normal, fg = theme.fg_normal })
    ...
    s.mybottomwibox = awful.wibar({ position = "bottom", opacity = 0.8, screen = s, border_width = 0, height = dpi(22), bg = theme.bg_normal, fg = theme.fg_normal })
