...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "w", function () awful.util.spawn( browser1 ) end,
        {description = FireFox, group = "function keys"}),

    awful.key({ modkey }, "k", function () awful.util.spawn( " kitty " ) end,
        {description = "File Manager", group = "super"}),

    awful.key({ modkey, modkey1 }, "Return", function () awful.util.spawn( " kitty -e sudo vifm" ) end,
        {description = "Root VIFM", group = "Personal"}),

    awful.key({ modkey, altkey }, "Return", function () awful.util.spawn( " kitty -e vifm" ) end,
        {description = "VIFM", group = "Personal"}),

    awful.key({ modkey }, "b", function () awful.util.spawn( "bitwarden-desktop" ) end,
        {description = "Bitwarden", group = "Personal"}),
  ...
  --  awful.key({ modkey }, "F4", function () awful.util.spawn( "gimp" ) end,
    ...
    -- [[[ Dmenu Scripts
      ...
      awful.key({ modkey, altkey }, "e", function () awful.util.spawn( " dm-confedit" ) end,
        {description = "dm-confedit", group = "dm-scripts"}),

      awful.key({ modkey, altkey }, "c", function () awful.util.spawn( " dm-currencies" ) end,
        {description = "dm-currencies", group = "dm-scripts"}),

      awful.key({ modkey, altkey }, "l", function () awful.util.spawn( " dm-logout" ) end,
        {description = "dm-logout", group = "dm-scripts"}),

      awful.key({ modkey, altkey }, "m", function () awful.util.spawn( " dm-man" ) end,
        {description = "dm-man", group = "dm-scripts"}),

      awful.key({ modkey, altkey }, "n", function () awful.util.spawn( " dm-note" ) end,
        {description = "dm-note", group = "dm-scripts"}),

      awful.key({ modkey, altkey }, "s", function () awful.util.spawn( " dm-websearch" ) end,
        {description = "dm-websearch", group = "dm-scripts"}),

      awful.key({ modkey, altkey }, "k", function () awful.util.spawn( " dm-kill" ) end,
        {description = "dm-kill", group = "dm-scripts"}),


    -- dmenu
    awful.key({ modkey}, "d",
    function ()
        --awful.spawn(string.format("dmenu_run -i -nb '#191919' -nf '#fea63c' -sb '#fea63c' -sf '#191919' -fn NotoMonoRegular:bold:pixelsize=20",
    ...
    awful.key({ modkey }, "t", function () awful.util.spawn( kitty ) end,
    ...
    awful.key({ modkey1, altkey   }, "t", function() awful.util.spawn( terminal2 ) end,
 ...
 -- Set applications to always map on the tag 8 on screen 1.
   ...
   -- Set applications to always map on the tag 8 on screen 1.
    { rule = { class = "Mailspring" },
        properties = { screen = 1, tag = awful.util.tagnames[8] , switchtotag = false  } },
